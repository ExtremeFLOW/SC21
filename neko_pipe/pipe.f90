...
contains
  ...
  subroutine user_f(u, v, w, j, k, l, e)
    ...
    real(kind=dp) :: Re_tau, Re_B                                                                        
    u = 0d0                                                                                              
    v = 0d0                                                                                              
    Re_tau = 180d0
    Re_B = 5300d0                                                                                        
    w = 2d0 * (2d0*Re_tau/Re_B)**2
  end subroutine user_f
  ...
  function pipe_ic(x, y, z) result(uvw)
    ...
    blt      = 5d0*7d-2  ! Fraction of boundary layer with momentum deficit
